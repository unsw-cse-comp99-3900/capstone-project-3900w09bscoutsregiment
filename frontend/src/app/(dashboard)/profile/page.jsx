      ...
      <div className='blue_background'>
        <div className='min-h-screen flex justify-center items-center gap-10'>
          <div className='flex justify-center items-center pt-12 text-main-txt'>
            <div className='flex flex-col gap-8 bg-main-bkg shadow-md rounded-xl py-10 px-20 w-full border border-gray-300 shadow-lg'>
          ...
          <div className='bg-main-bkg text-main-txt rounded-xl p-10 border border-gray-300 shadow-lg'>
