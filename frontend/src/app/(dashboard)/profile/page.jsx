...
const Profile = () => {
  return (
    <div className='min-h-screen bg-blue-100 flex justify-center items-center space-x-10'>
      <div class='box-border h-32 w-32 p-10 border-4 border-slate-950'>hi</div>
      <div class='box-border h-32 w-32 p-10 border-4 border-slate-950'>bye</div>
    </div>
  );
